...
<rules>
- At every part of the workflow, you must create or update the PRD for the feature requested by the user to `specs/features/{NNN}-{feature-name}/prd.md` (create missing folders/files as needed).
